      ...
      <ContentWrapper>
        <Terminal>
          <TerminalHeader>
            ...
            <TerminalTitle>trenton@portfolio ~ </TerminalTitle>
          </TerminalHeader>
          <TerminalBody>
            ...
            {isTypingComplete && (
              <>
                <CommandLine>
                  <span>trenton@portfolio ~ </span>
                  <Command>node index.js</Command>
                </CommandLine>
                
                {showAdditionalInfo && (
                  <OutputContainer>
                    <OutputText>Hello! Thanks for visiting my portfolio. I'm a Full Stack Developer passionate about creating elegant solutions to complex problems.</OutputText>
                    <ButtonContainer>
